...
export function CambiarPasswordForm({
  ...
  return (
    // `div`, no `main`: el layout del grupo `(app)` ya aporta el landmark
    // principal y dos `main` anidados rompen la navegación por landmarks.
    <div className="relative flex flex-1 flex-col justify-center overflow-hidden px-4 py-10">
      {/* Cabecera de formulario del shell móvil (issue #52). */}
      <CabeceraMovil
        className="lg:hidden"
        variante="formulario"
        nivel="p"
        ...
        atras={
          forzado ? undefined : { href: "/perfil", etiqueta: "Volver a perfil" }
        }
      />
