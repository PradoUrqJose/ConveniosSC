...
export function EnlaceNav({ destino, className, children }: Props) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group/nav relative flex min-h-11 items-center gap-3 overflow-hidden rounded-xl px-3.5 text-sm font-semibold transition-[color,background-color,box-shadow] duration-200",
        activo
