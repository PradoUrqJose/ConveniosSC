...
export function BannerInstalacion() {
  ...
  return (
    <div
      ...
      className="border-border/80 bg-card/96 fixed inset-x-3 bottom-[calc(4.2rem+env(safe-area-inset-bottom))] z-50 mx-auto max-w-md overflow-hidden rounded-[1.4rem] border p-4 shadow-[0_24px_70px_rgba(15,23,42,.24)] backdrop-blur-xl lg:right-5 lg:bottom-5 lg:left-auto"
    >
